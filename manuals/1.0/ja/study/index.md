...
- [依存性注入の原則](01-foundations/dependency-injection-principles.html) - 制御の反転、疎結合の実現
- [SOLID原則の実践](01-foundations/solid-principles.html) - 実際のコードを通じた5つの原則の理解
...
- [Factoryパターン](02-object-creation/factory-pattern.html) - 使用時期: 実行時パラメータが必要な場合
- [Providerパターン](02-object-creation/provider-pattern.html) - 使用時期: 複雑な初期化が必要な場合
- [Null Object Pattern](02-object-creation/null-object-pattern.html) - 使用時期: オプショナルな依存関係をnullチェックなしで扱う場合
...
- [Strategyパターン](03-behavioral/strategy-pattern.html) - 使用時期: 実行時にアルゴリズムを切り替える場合
- [Decoratorパターン & AOP](03-behavioral/decorator-aop.html) - 使用時期: ログ、トランザクションなどを分離する場合
...
- [Adapterパターン](04-architecture/adapter-pattern.html) - 使用時期: 外部APIやライブラリを適合させる場合
- [Repositoryパターン](04-architecture/repository-pattern.html) - 使用時期: データアクセスをビジネスロジックから分離する場合
- [Service Layer](04-architecture/service-layer.html) - 使用時期: ビジネスロジックを調整する場合
- [モジュール設計](04-architecture/module-design.html) - 使用時期: DI設定が100行を超える場合
...
**OOP初心者の方**
推奨順序: [依存性注入の原則](01-foundations/dependency-injection-principles.html) → [SOLID原則](01-foundations/solid-principles.html) → [Factoryパターン](02-object-creation/factory-pattern.html)

**経験豊富な開発者の方**
どこからでも開始できます！各セクションは独立しています。

**アーキテクト向け**
推奨: [SOLID原則](01-foundations/solid-principles.html) → [アーキテクチャパターン](04-architecture/repository-pattern.html)
...
**開始:** [依存性注入の原則](01-foundations/dependency-injection-principles.html)
