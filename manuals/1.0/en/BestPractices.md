...
*   [Avoid cyclic dependencies](bp/cyclic_dependencies.html)
...
*   [Keep constructors as hidden as possible](bp/keep_constructors_hidden.html)
*   [Don't reuse binding annotations (aka `#[Qualifiers]`)](bp/dont_reuse_annotations.html)
