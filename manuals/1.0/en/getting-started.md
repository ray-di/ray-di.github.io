...
[Dependency injection](https://en.wikipedia.org/wiki/Dependency-injection) is a design pattern wherein classes declare their dependencies as arguments instead
...
In a real application, the dependency graph for objects will be much more complicated and Ray.Di makes creating complex object easy by creating all the [transitive dependencies](https://en.wikipedia.org/wiki/Transitive-dependency) automatically.
...
Read more on how to conceptualize Ray.Di with a simple [mental model](mental-model.html).
